...
public class Mirafit_ShopbySports_Test 
{
	...
	@Test(priority=2)
	public void ShopbySports() throws InterruptedException
	{
		
		Shop_By_Sport.Moveto_ShopbySports(driver);
		
		Shop_By_Sport.GetProductImage();
		
		JavascriptExecutor js = (JavascriptExecutor)driver;
		js.executeScript("window.scrollBy(0,300)");
		
		Shop_By_Sport.click_Wish_List();
		
		Shop_By_Sport.Get_Wishlist_Message();
		
		Shop_By_Sport.Click_Continue_shopping();
		
		js.executeScript("window.scrollBy(0,300)");

		Shop_By_Sport.Click_View_Details(driver);
		
		Shop_By_Sport.Get_Stock();
		
		Shop_By_Sport.Get_Reviews();
		
		Shop_By_Sport.Click_Choice();
		
		Shop_By_Sport.Click_Add_To_Cart(driver);
		
		Shop_By_Sport.Click_On_Cart_Button(driver);
		
		Shop_By_Sport.Click_Remove_item_from_Cart(driver);
		
		Shop_By_Sport.Get_EmptyCartMessage();
