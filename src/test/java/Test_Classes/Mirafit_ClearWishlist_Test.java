...
public class Mirafit_ClearWishlist_Test 
{
	...
	public void wishlist() throws InterruptedException
	{
		...
		Clear_Wishlist.Moveto_Strength(driver);
		
		Clear_Wishlist.GetProductImage();
		

		JavascriptExecutor js = (JavascriptExecutor)driver;
		js.executeScript("window.scrollBy(0,300)");	
			
		Clear_Wishlist.click_Wish_List();
		
		Clear_Wishlist.Get_Wishlist_Message();
		
		Clear_Wishlist.Click_Remove_From_wishlist();
		
		Clear_Wishlist.Get_Remove_From_wishlist_Message();
