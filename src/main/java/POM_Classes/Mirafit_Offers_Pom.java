...
{
	@FindBy (xpath = "(//span[@class='caret'])[15]") private WebElement Offers;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[92]") private WebElement Strength_Equipements;
	...
	@FindBy(xpath = "//a[@class='action tocart primary'][1]") private WebElement ViewDetails;
