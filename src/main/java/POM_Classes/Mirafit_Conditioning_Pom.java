...
{
	@FindBy (xpath = "(//span[@class='caret'])[9]") private WebElement Conditioning;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[50]") private WebElement Exercise_Mats;
