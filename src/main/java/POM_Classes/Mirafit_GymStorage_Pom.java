...
public class Mirafit_GymStorage_Pom 
{
	...
	@FindBy (xpath = "(//span[@class='caret'])[10]") private WebElement Gym_Storage;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[66]") private WebElement Plate_Storage;
