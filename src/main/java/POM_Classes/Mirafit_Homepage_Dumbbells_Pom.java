...
public class Mirafit_Homepage_Dumbbells_Pom 
{
	
	@FindBy(xpath = "(//a[@class='logo'])[2]") private WebElement Logo;
	@FindBy(xpath = "//a[@class='sde-btn']") private WebElement Dumbbells;
	...
	public Mirafit_Homepage_Dumbbells_Pom(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}	
	
	public void Click_Dumbbells_Button(WebDriver driver) throws InterruptedException
	{
		Logo.click();
		Thread.sleep(2000);
