...
public class Mirafit_ShopbySports_Pom
{
	...
	@FindBy (xpath = "(//span[@class='caret'])[12]") private WebElement ShopbySports;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[79]") private WebElement Climbing;
