...
public class Mirafirt_Remove_AllFromCart_Pom
{
	...
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[3]") private WebElement parallelbar;
	...
	@FindBy(xpath = "//a[@class='action continue']") private WebElement Continue;
	@FindBy(xpath = "//span[text()='POWER RACKS']") private WebElement Power_Racks;
	@FindBy(xpath = "(//a[@class='action tocart primary'])[1]") private WebElement cart;
	@FindBy(xpath = "//div[@class='stock available']") private WebElement Stock1;
	@FindBy(xpath = "//a[@class='action view']") private WebElement Reviews1;
	@FindBy(id = "attribute446") private WebElement Size;
	@FindBy(id = "attribute447") private WebElement Choice1;
	@FindBy(id = "product-addtocart-button") private WebElement AddToCart1;
	@FindBy(xpath = "(//span[@class='caret'])[1]") private WebElement CartButton1;
	@FindBy(xpath = "//a[@class='action viewcart']") private WebElement ViewAndCartButton1;
	@FindBy(xpath = "//div[@class='message message-success success']") private WebElement CartMessage1;
